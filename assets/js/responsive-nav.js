!function(a, b, c) {
    ...
    var d = function(d, e) {
        ...
        var g, h, i, j, k, l, m = function(a, b, c, d) {
            ...
            var d;
            this.options = {animate: !0,transition: 400,label: "Menu",insert: "before",customToggle: "navigation-toggle",closeOnNavClick: !1,openPos: "fixed",navClass: "nav-collapse",navActiveClass: "js-nav-active",jsClass: "js",init: function() {
                },open: function() {
                },close: function() {
                }};
            for (d in c)
        ...
        return v.prototype = {destroy: function() {
                ...
                "none" !== b.getComputedStyle(i, null).getPropertyValue("display") ? (k = !0, p(i, {"aria-hidden": "false"}), g.className.match(/(^|\s)closed(\s|$)/) && (p(g, {"aria-hidden": "true"}), g.style.position = "absolute"), this._createStyles(), this._calcwidth()) : (k = !1, p(i, {"aria-hidden": "true"}), p(g, {"aria-hidden": "false"}), g.style.position = h.openPos, this._removeStyles())
                ...
                if (h.animate) {
                    var a = g.style, b = "" + h.transition + "ms";
                    a.WebkitTransition = b, a.MozTransition = b, a.OTransition = b, a.transition = b
                }
            },_calcwidth: function() {
                for (var a = 0, b = 0; b < g.inner.length; b++)
                    a += g.inner[b].offsetwidth;
                var c = "." + h.jsClass + " ." + h.navClass + "-" + this.index + ".opened{" + a + "px !important}";
